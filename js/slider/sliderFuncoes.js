function carregarSliderPorDiv(idDiv,nomeFotoComCaminho,totalFotos) {
    ...
    if(outputDiv){ 
        var result = "<section class='slider'>";
                result += "<div class='hero-slider' style='-webkit-box-shadow: 0px 10px 13px -7px #000000, 10px 17px 20px -9px rgb(59,83,255);box-shadow: 0px 10px 13px -7px #000000, 10px 17px 20px -9px rgb(59,83,255);border-radius: 9px;'>";
